...
1. Pfade zu den für das Erstellen der Videos benötigten Konsolen-Programme
	...
	```$converter["gif"]``` unterstützt zurzeit nur die "copy"-Methode, daher darf für die gif-Unterstützung der Konfigurationsparameter nicht verändert werden, es sei denn, man möchte keine GIF Datei erzeugen. Hierfür muss der Parameter auf folgenden Wert verändert werden:
	```$converter["gif"] = false;```
